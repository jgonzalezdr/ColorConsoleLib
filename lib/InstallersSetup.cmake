...
if( ENABLE_INSTALLER )
    ...
    if( NOT WIN32 )
        ...
        # Uncomment the following command to set debian package build dependancies
        #set( DEBIAN_PACKAGE_BUILD_DEPENDS "somelibrary-9-dev | somelibrary-8-dev, anotherlibrary-dev (>=6)" )

        set( DEBIAN_PACKAGE_CMAKE_OPTIONS "-DENABLE_TEST=OFF" )
